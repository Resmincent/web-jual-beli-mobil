...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Form Penjualan Kendaraan</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="vehicle_id" id="vehicle_id" class="form-select form-control" required>
                                ...
                                <option value="{{ $vehicle->id }}" data-price="{{ $vehicle->price }}">
                                    {{ $vehicle->name }} - {{ $vehicle->year }} ({{ $vehicle->brands->name ?? 'Tanpa Brand' }})
                                </option>

                                @endforeach
                            </select>
                            <div id="vehicleInfo" class="mt-2 small text-muted d-none">
                                Harga Dasar: <span id="basePrice" class="font-weight-bold"></span>
                            </div>
                        </div>
